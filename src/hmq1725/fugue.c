...
#define SMIX(x0, x1, x2, x3)                                                                                                                                                                \
    do {                                                                                                                                                                                    \
        ...
        tmp = mixtab3[x3 & 0xFF];                                                                                                                                                           \
        c3 ^= tmp;                                                                                                                                                                          \
        x0 = ((c0 ^ r0) & SPH_C32(0xFF000000)) | ((c1 ^ r1) & SPH_C32(0x00FF0000)) | ((c2 ^ r2) & SPH_C32(0x0000FF00)) | ((c3 ^ r3) & SPH_C32(0x000000FF));                                 \
        x1 = ((c1 ^ (r0 << 8)) & SPH_C32(0xFF000000)) | ((c2 ^ (r1 << 8)) & SPH_C32(0x00FF0000)) | ((c3 ^ (r2 << 8)) & SPH_C32(0x0000FF00)) | ((c0 ^ (r3 >> 24)) & SPH_C32(0x000000FF));    \
        x2 = ((c2 ^ (r0 << 16)) & SPH_C32(0xFF000000)) | ((c3 ^ (r1 << 16)) & SPH_C32(0x00FF0000)) | ((c0 ^ (r2 >> 16)) & SPH_C32(0x0000FF00)) | ((c1 ^ (r3 >> 16)) & SPH_C32(0x000000FF)); \
        x3 = ((c3 ^ (r0 << 24)) & SPH_C32(0xFF000000)) | ((c0 ^ (r1 >> 8)) & SPH_C32(0x00FF0000)) | ((c1 ^ (r2 >> 8)) & SPH_C32(0x0000FF00)) | ((c2 ^ (r3 >> 8)) & SPH_C32(0x000000FF));    \
        /* */                                                                                                                                                                               \
    } while (0)
...
static void
fugue_init(sph_fugue_context* sc, size_t z_len, const sph_u32* iv, size_t iv_len)
{
    size_t u;
...
#define INCR_COUNTER                                                             \
    do {                                                                         \
        ...
        if (sc->bit_count_low < tmp)                                             \
            sc->bit_count_high++;                                                \
        sc->bit_count_high = SPH_T32(sc->bit_count_high + ((sph_u32)len >> 29)); \
    } while (0)
...
static void
fugue2_close(sph_fugue_context* sc, unsigned ub, unsigned n, void* dst, size_t out_size_w32)
{
    int i;
