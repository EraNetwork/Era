...
// Copyright (c) 2009-2012 The Era Developers
...
public:
    ...
    CEraAddress(const std::string& strAddress)
    {
        SetString(strAddress);
    }

    CEraAddress(const char* pszAddress)
    {
...
public:
    ...
    CEraSecret(const CKey& vchSecret)
    {
        SetKey(vchSecret);
    }
...
typedef CEraExtKeyBase<CExtKey, 74, CChainParams::EXT_SECRET_KEY> CEraExtKey;
typedef CEraExtKeyBase<CExtPubKey, 74, CChainParams::EXT_PUBLIC_KEY> CEraExtPubKey;
