...
/**
  Era GUI main class. This class represents the main window of the Era UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class EraGUI : public QMainWindow
{
    Q_OBJECT
