...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Era
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Era
    // Mac: ~/Library/Application Support/Era
    // Unix: ~/.era
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Era";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "era.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
    {
        boost::filesystem::path ConfPath;
               ...
               fprintf(ConfFile, "port=13546\n");
               fprintf(ConfFile, "rpcport=13547\n");
    ...
    {
        // Don't overwrite existing settings so command line settings override era.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "erad.pid"));
